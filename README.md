# Домашнее задание к занятию "`Git`" - `Каргапольцев Константин Сергеевич`
...
1. `https://github.com/KargapoltcevKS/Git_1/blob/main/README.md`
...
1. `https://github.com/KargapoltcevKS/Git_1/blob/main/.gitignore`
...
1. `https://github.com/KargapoltcevKS/Git_1/network`
